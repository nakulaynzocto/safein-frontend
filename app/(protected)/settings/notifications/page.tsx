...
function NotificationsPageContent() {
    ...
    const pendingAppointments = (appointmentsData?.appointments || []).filter((appointment) => {
    ...
    return (
        <div className="space-y-6">
            {/* Header */}
            <PageHeader title="Notifications" description="Review and manage pending appointment requests">
                <Button onClick={handleRefresh} variant="outline" size="sm" disabled={isProcessing || isRefreshing}>
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-muted-foreground mt-1 text-xs">Completed today</p>
                    </CardContent>
                </Card>
                ...
                <Card className="sm:col-span-2 lg:col-span-1">
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold">0</div>
                        <p className="text-muted-foreground mt-1 text-xs">Declined today</p>
                    </CardContent>
                </Card>
            </div>
                ...
                {pendingAppointments.length === 0 ? (
                    <Card>
                        <CardContent className="p-8 text-center">
                            ...
                            <h3 className="text-foreground mb-2 text-lg font-medium">No Pending Notifications</h3>
