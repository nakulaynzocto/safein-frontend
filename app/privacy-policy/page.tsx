        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Card className="mb-6">
            ...
            <CardContent className="space-y-4 text-sm text-gray-700">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-2">2. Visitor Information</h3>
                <ul className="list-disc list-inside space-y-1 ml-4">
          ...
          <Card className="mb-6">
            ...
            <CardContent className="space-y-4 text-sm text-gray-700">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>Your payment information is processed directly by Razorpay and is not stored on our servers</li>
                <li>Razorpay complies with PCI DSS (Payment Card Industry Data Security Standard) requirements</li>
                <li>We only receive payment confirmation and transaction details necessary for subscription management</li>
          ...
          <Card className="mb-6">
            ...
            <CardContent className="space-y-4 text-sm text-gray-700">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li><strong>Payment Processing:</strong> With Razorpay for processing subscription payments</li>
                <li><strong>Service Providers:</strong> With trusted third-party service providers who assist in operating our platform (email services, cloud hosting)</li>
          ...
          <Card className="mb-6">
            ...
            <CardContent className="space-y-4 text-sm text-gray-700">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>Upon account deletion, data is removed within 30 days unless legal retention applies</li>
              </ul>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-4 text-sm text-gray-700">
              ...
              <div className="space-y-2 ml-4">
                <div className="flex items-center gap-2">
                  ...
                  <span>Email: <a href="mailto:support@aynzo.com" className="text-[#3882a5] hover:underline">support@aynzo.com</a></span>
                </div>
                <div className="flex items-center gap-2">
