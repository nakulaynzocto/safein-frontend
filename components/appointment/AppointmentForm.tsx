...
export function NewAppointmentModal({
  ...
  useEffect(() => {
    if (isEditMode && existingAppointment && open) {
      ...
      const hasVehicleData = existingAppointment?.appointmentDetails?.vehicleNumber || existingAppointment?.appointmentDetails?.vehiclePhoto
      ...
      <div className="pt-4 border-t">
        <div className="flex items-center justify-between p-4 bg-muted/30 rounded-lg border">
          <div className="flex items-center gap-3">
            ...
            <div>
              <Label htmlFor="vehicle-fields-toggle" className="text-sm font-medium cursor-pointer">
