    ...
    return (
        ...
        >
            <SwitchPrimitive.Thumb
                ...
                className={cn(
                    "bg-background border-input/50 pointer-events-none block h-5 w-5 rounded-full border shadow-sm ring-0 transition-transform data-[state=checked]:translate-x-5 data-[state=unchecked]:translate-x-0.5",
                )}
            />
        </SwitchPrimitive.Root>
    );
