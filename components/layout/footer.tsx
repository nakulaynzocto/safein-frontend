    ...
    },
    {
        ...
        icon: (
            <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                <path
                    fillRule="evenodd"
                    d="M19.615 3.184c-1.07-.128-6.315-.214-7.615-.214s-6.545.086-7.615.214C2.928 3.37 2 4.318 2 5.795v12.41c0 1.477.928 2.425 2.385 2.611 1.07.128 6.315.214 7.615.214s6.545-.086 7.615-.214c1.457-.186 2.385-1.134 2.385-2.611V5.795c0-1.477-.928-2.425-2.385-2.611zM9.5 15.768V8.232l6.5 3.768-6.5 3.768z"
                    clipRule="evenodd"
                />
            </svg>
        ),
            ...
            <div className="relative z-10 w-full px-6 py-16 sm:px-12 lg:px-16">
                ...
                <div className="mt-8 border-t border-white/10 pt-8 text-center">
                    <p className="text-sm text-gray-300">
                        © {new Date().getFullYear()} Aynzo. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
