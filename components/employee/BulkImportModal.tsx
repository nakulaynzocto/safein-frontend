        ...
        try {
            ...
            if (result.failedCount > 0) {
                ...
                if (skippedCount > 0 && errorCount === 0) {
                    showSuccessToast(
                        `${skippedCount} duplicate employee(s) skipped. Only unique emails were imported.`,
                    );
                } else if (skippedCount > 0 && errorCount > 0) {
                    showErrorToast(
                        `${skippedCount} duplicate(s) skipped, ${errorCount} error(s) occurred. Check details below.`,
                    );
                } else {
        ...
        <Dialog open={open} onOpenChange={handleClose}>
            <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-[600px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Download the template, fill in employee information, and upload the Excel file to import
                ...
                <div className="space-y-6 py-4">
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center gap-2">
                            ...
                            <h3 className="text-sm font-semibold">Step 2: Upload Excel File</h3>
                        </div>
                        <p className="text-sm text-gray-600">
                ...
                <DialogFooter>
                    ...
                    <Button onClick={handleUpload} disabled={!file || isUploading || !!importResult}>
                        {isUploading ? (
                            <>
                                <LoadingSpinner className="mr-2 h-4 w-4" />
                                Uploading...
