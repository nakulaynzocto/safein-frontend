...
const PAGINATION_CLASSES = {
  baseLink: "flex items-center justify-center min-w-[32px] h-8 px-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md transition-colors cursor-pointer",
  ...
  activeLink: "flex items-center justify-center min-w-[32px] h-8 px-2 text-sm font-medium !bg-[#3882a5] !border-[#3882a5] !text-white rounded-md hover:!bg-[#2d6a87] hover:!border-[#2d6a87] transition-colors cursor-pointer shadow-sm",
  activeLinkCompact: "flex items-center justify-center min-w-[32px] h-8 px-2 text-sm font-medium text-white bg-[#3882a5] border border-[#3882a5] rounded-md hover:bg-[#2d6a87] hover:border-[#2d6a87] transition-colors cursor-pointer shadow-sm",
  breakLink: "flex items-center justify-center min-w-[32px] h-8 px-2 text-sm font-medium text-gray-500 dark:text-gray-400",
} as const
  ...
  return (
    <div className={cn("flex flex-col sm:flex-row items-center justify-between gap-4", className)}>
      ...
      <div className="text-sm text-gray-600 dark:text-gray-400">
        Showing <span className="font-medium">{startItem || 0}</span> to <span className="font-medium">{endItem || 0}</span> of <span className="font-medium">{safeTotalItems || 0}</span> items
      </div>
...
export function CompactPagination({
  ...
  return (
    <div className={cn("flex flex-col sm:flex-row items-center justify-between gap-4", className)}>
      <div className="text-sm text-gray-600 dark:text-gray-400">
        <span className="font-medium">{startItem || 0}</span>-<span className="font-medium">{endItem || 0}</span> of <span className="font-medium">{safeTotalItems || 0}</span>
      </div>
      <ReactPaginate
