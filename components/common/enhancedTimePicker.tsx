        ...
        <PopoverTrigger asChild>
          <Button
            ...
            className={cn(
              ...
              !value && "text-muted-foreground hover:text-white hover:bg-[#3882a5]",
              error && "border-destructive focus:ring-destructive"
            )}
          >
            <Clock className="mr-2 h-4 w-4" />
            {displayValue || <span className="text-muted-foreground group-hover:text-white">Select time</span>}
          </Button>
        </PopoverTrigger>
                  ...
                  return (
                    <Button
                      ...
                      className={cn(
                        ...
                        isSelected && "bg-[#3882a5] hover:bg-[#2d6a87] text-white"
                      )}
