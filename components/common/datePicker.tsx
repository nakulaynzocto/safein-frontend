      ...
      <div className="space-y-1.5">
        ...
        <div className="relative">
          <input
            ...
            className={cn(
              "flex h-9 w-full rounded-md border border-border bg-input pl-3 pr-10 py-2 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50",
